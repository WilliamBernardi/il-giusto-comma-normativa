...
data: 2004-12-01
titolo: ""
urn: urn:nir:ministero.infrastrutture.e.trasporti:decreto:2004-12-01;328
codice_redazionale: 005G0013
vigente: true
...
Nell'articolo 6, comma 1, del decreto, dopo la parola "Capitaneria", sono inserite le seguenti: ", uno per il Reparto di Volo o per il Reparto Supporto Navale".

Nell'articolo 6, commi 2 e 5, del decreto, dopo le parole "Reparto di Volo", sono inserite le seguenti: "o del Reparto Supporto Navale".

## Art. 3.

Nell'articolo 7, comma 1, del decreto, dopo le parole "Reparto di Volo", sono inserite le seguenti: "nonche' Reparto Supporto Navale".

Nell'articolo 8, comma 1, del decreto, dopo le parole "uffici marittimi", sono inserite le seguenti: "o dei Comandi interessati".

## Art. 4.

L'articolo 9, comma 1, del decreto, e' sostituito dal seguente:
...
L'articolo 10 del decreto e' sostituito dal seguente:
...
L'articolo 12 del decreto e' sostituito dal seguente:
...
L'articolo 13, comma 1, del decreto, e' sostituito dal seguente:
...
Nell'articolo 13, comma 3, del decreto, e' aggiunto, in fine, il seguente periodo:
...
L'articolo 14 del decreto e' sostituito dal seguente:
...
Nella rubrica dell'articolo 15 del decreto, dopo l'acronimo "ASC", e' aggiunto il seguente: "e APP".

All'articolo 15, i commi 4 e 5 del decreto sono sostituiti dai seguenti:
...
La rubrica dell'articolo 17 del decreto, e' sostituita dalla seguente:
 "Decadenza dell'assegnazione degli ASI, AST, SLI e ASC".

L'alinea del comma 1 dell'articolo 17 del decreto, e' sostituito dal seguente:
 "1. Gli assegnatari degli ASI, AST, SLI e ASC decadono dal rispettivo beneficio nei seguenti casi:".

All'articolo 17, comma 1, la lettera f) del decreto e' sostituita dalla seguente:
...
Nell'articolo 18 del decreto, ai commi 3 e 4, le parole "Nucleo Aereo" sono sostituite dalle seguenti: "Reparto di Volo o Comandante del Reparto Supporto Navale".

## Art. 12.

L'articolo 19, comma 3, del decreto, e' sostituito dal seguente:
...
All'articolo 19 del decreto, il comma 4 e' sostituito dal seguente:
...
Nella rubrica dell'Allegato "A" al decreto, dopo l'acronimo "ASI" sono inseriti i seguenti: ",AST e SLI".

Nella nota a in calce all'Allegato "A" al decreto, dopo le parole "Reparti di Volo", sono inserite le seguenti: "Reparto Supporto Navale".

La rubrica dell'Allegato "B" al decreto e' sostituita dalla seguente: "Atto di formalizzazione dell'assegnazione di alloggio di servizio".

Nelle note a, l ed m in calce all'Allegato "G" al decreto ministeriale 28 settembre 2001, n. 414, dopo le parole "Nucleo Aereo", sono aggiunte le seguenti: "o Reparto Supporto Navale".

Nelle note a e k in calce all'Allegato "H" al decreto ministeriale 28 settembre 2001, n. 414, dopo le parole "Nucleo Aereo", sono aggiunte le seguenti: "o Reparto Supporto Navale".
