...
## Art. 6-bis. — Utilizzo di sistemi di identificazione automatica, AIS, da parte delle unita' da pesca).
...
## Art. 6-ter. — (((Utilizzo di sistemi di identificazione e tracciamento a lungo raggio delle navi, LRIT). ))
...
## Art. 9. — (( (Gestione dei sistemi di monitoraggio ed informazione sul traffico marittimo - VTMIS nazionale). ))
...
## Art. 11. — ((ARTICOLO ABROGATO DAL D.LGS. 6 SETTEMBRE 2011, N. 165))



## - Titolo III COMUNICAZIONE DELLE MERCI PERICOLOSE O INQUINANTI A BORDO DELLE NAVI (HAZMAT)

## Art. 12. — Informazioni concernenti il trasporto di merci pericolose o inquinanti).
...
## Art. 13. — ((Obbligo di comunicazione delle merci pericolose o inquinanti trasportate a bordo))
...
## Art. 14-bis. — Portale per lo scambio telematico di dati tra gli armatori, proprietari, agenti raccomandatari, compagnie o comandanti delle navi e le amministrazioni - PMIS).
...
## Art. 20. — (( (Autorita' competente per l'accoglienza delle navi che necessitano di assistenza). ))
...
## Art. 20-bis. — (( (Piani per l'accoglienza delle navi che necessitano di assistenza) ))
...
## Art. 20-ter. — (( (Decisione relativa all'accoglienza delle navi) 
...
## Art. 20-quater. — (( (Sicurezza finanziaria e compensazioni). ))
